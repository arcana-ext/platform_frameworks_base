...
import com.android.systemui.ArcanaSystemUIUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public NotificationPanelViewController(NotificationPanelView view,
        ...
        mDoubleTapToSleepGesture = new GestureDetector(mView.getContext(),
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ArcanaUtils.switchScreenOff(mView.getContext());
                return true;
            }
        });
    ...
    public void reTickerView(boolean visibility) {
        if (!ArcanaSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (ArcanaSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!ArcanaSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
